...
function SingleServiceComponent(props) {
  ...
  return (
    <>
      <div
        id={props.id}
        className=" overflow-hidden flex items-center w-full h-[100%] sm:h-screen  top-10 left-0"
      >
        <div className=" S-scroll_top    md:w-[40%] lg:w-6/12 h-[100%] sm:h-screen  bg-center bg-cover   md:flex flex-col justify-evenly items-center ">
        ...
        >
          <div    id={props.id} className="absolute z-[900] flex justify-evenly sm:justify-center items-start h-[100%] sm:h-screen w-[98%] sm:w-[90%]  md:w-[60%] lg:w-6/12 flex-col px-10">
            ...
            <div className="flex gap-y-3 gap-x-6 sm:gap-9 mt-4 flex-wrap S-scroll_top">
      ...
      <div
        ...
        className={`${props.id} relative w-full flex justify-center  h-[70vh] bg-center bg-fixed bg-cover items-center my-20 `}
      >

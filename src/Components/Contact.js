...
function Contact() {
  ...
  return (
    <>
      <div className=" flex h-screen w-full row justify-stretch items-center overflow-hidden ">
        <div className= " slide_left relative w-[40%] bg-zinc-950 h-full rounded-r-full flex flex-col justify-center items-center z-[100] ">
        ...
        <div className="w-[60%]  h-full flex justify-center  items-center slide_from_left">
          {isSubmitted ? (
            ...
            <div>
              <form
                ...
                className="p-6 w-[100%] rounded shadow-sm shadow-[#030528]"
              >
